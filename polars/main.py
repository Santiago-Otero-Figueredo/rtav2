...
def cruce_addi_erp():
    ...
    config_addi = ConfiguracionLector(ruta_archivo='insumos/addi/Resumen general ADDI.xlsx')
    lector = LectorADDI(config_addi)
    df_addi = lector.dataframe()
